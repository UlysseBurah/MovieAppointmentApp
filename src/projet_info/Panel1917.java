 ...
 * @author ulyss
 */
public class Panel1917 extends JPanel
{
    ...
    Panel1917(Film film1917)
    {
        this.film1917 = film1917;
        
        JLabel picLabel = new JLabel(new ImageIcon(film1917.myImage));
